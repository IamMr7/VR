...
InlineKeyboardButton(" member keyboard ", callback_data="Q_XUQ"),
                ...
                [                
                    ...
                    InlineKeyboardButton(" Donate ", url=f"https://t.me/D_Z_A_R"),
                ],
                [
                    InlineKeyboardButton(
                        "🦅 𝙎𝙊𝙐𝙍𝘾𝙀 𝙑𝙍 🦅", url=f"https://t.me/D_Z_A_R"
                    ),
                    InlineKeyboardButton(
                        "‹ المطور ›", url=f"https://t.me/jamthon"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
\n√ **في حال واجهت اي مشكلة اخرى يمكنك التواصل مع المطور من هنا : @jamthon **
\n __ Developer """,
        reply_markup=InlineKeyboardMarkup(
